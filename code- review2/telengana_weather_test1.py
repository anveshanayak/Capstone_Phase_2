...
for month, uuid in month_uuids.items():
    ...
    df_month.to_csv("C:\Anna_Data_D_files\sem6\z_capstone\Agriculture\A_Phase_2\code- review2\preprocessed_files\Telengana_weather\temperature_data_{month}.csv", index=False)  # Save each month to a separate CSV file
